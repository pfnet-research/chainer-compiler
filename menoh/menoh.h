...
typedef int64_t menoh_error_code;
...
menoh_error_code MENOH_API menoh_model_data_get_input_name_list_size(
        menoh_model_data_handle model_data, int64_t* dst_size);

/*! \brief Get a size of input name which does not include '\0'
 */
menoh_error_code MENOH_API menoh_model_data_get_input_name_size(
        menoh_model_data_handle model_data, int64_t index, int64_t* dst_size);
 ...
 */
menoh_error_code MENOH_API menoh_model_data_get_input_name(
        menoh_model_data_handle model_data, int64_t index, char* dst_name);

menoh_error_code MENOH_API menoh_model_data_get_output_name_list_size(
        menoh_model_data_handle model_data, int64_t* dst_size);

menoh_error_code MENOH_API menoh_model_data_get_output_name_size(
        menoh_model_data_handle model_data, int64_t index, int64_t* dst_size);

menoh_error_code MENOH_API menoh_model_data_get_output_name(
        menoh_model_data_handle model_data, int64_t index, char* dst_name);
