...
class TestPrimitive(unittest.TestCase):
    ...
    def test_for_3(self):
        ...
        self.assertEqual(str(node_type[1]), "(int, int)")	# lineno: 2
        self.assertEqual(str(node_type[5]), "NoneType")	# lineno: 3
        self.assertEqual(str(node_type[6]), "int")	# lineno: 3
        ...
        self.assertEqual(str(node_type[13]), "NoneType")	# lineno: 5
        self.assertEqual(str(node_type[14]), "int")	# lineno: 5
        self.assertEqual(str(node_type[16]), "int list")	# lineno: 5
        self.assertEqual(str(node_type[17]), "int -> int list")	# lineno: 5
        self.assertEqual(str(node_type[19]), "int")	# lineno: 5
        self.assertEqual(str(node_type[20]), "NoneType")	# lineno: 6
        self.assertEqual(str(node_type[21]), "int")	# lineno: 6
        self.assertEqual(str(node_type[23]), "int")	# lineno: 6
        self.assertEqual(str(node_type[25]), "NoneType")	# lineno: 7
        self.assertEqual(str(node_type[26]), "int")	# lineno: 7
        self.assertEqual(str(node_type[28]), "int")	# lineno: 7
        self.assertEqual(str(node_type[30]), "(int, int)")	# lineno: 8
        self.assertEqual(str(node_type[31]), "(int, int)")	# lineno: 8
        self.assertEqual(str(node_type[32]), "int")	# lineno: 8
        self.assertEqual(str(node_type[34]), "int")	# lineno: 8
