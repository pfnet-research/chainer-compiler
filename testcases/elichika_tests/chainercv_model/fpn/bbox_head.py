...
from testcases.elichika_tests.chainercv_model.fpn.misc import argsort
from testcases.elichika_tests.chainercv_model.fpn.misc import choice
    ...
    def decode(self, rois, roi_indices, locs, confs,
        ...
        Args:
            ...
            scales (list of floats): A list of floats returned
                by :meth:`~testcases.elichika_tests.chainercv_model.fpn.faster_rcnn.prepare`
