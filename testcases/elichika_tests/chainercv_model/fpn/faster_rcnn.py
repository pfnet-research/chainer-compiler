...
from testcases.elichika_tests.chainercv_model.fpn.misc import scale_img
...
class FasterRCNN(chainer.Chain):
    ...
    Args:
        ...
        rpn (Link): A link that has the same interface as
            :class:`~testcases.elichika_tests.chainercv_model.fpn.RPN`.
            Please refer to the documentation found there.
        bbox_head (Link): A link that has the same interface as
            :class:`~testcases.elichika_tests.chainercv_model.fpn.BboxHead`.
            Please refer to the documentation found there.
        mask_head (Link): A link that has the same interface as
            :class:`~testcases.elichika_tests.chainercv_model.fpn.MaskHead`.
            Please refer to the documentation found there.
