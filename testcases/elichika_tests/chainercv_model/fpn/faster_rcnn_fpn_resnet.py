...
from testcases.elichika_tests.chainercv_model.fpn.faster_rcnn import FasterRCNN
...
from testcases.elichika_tests.chainercv_model.resnet import ResNet101
...
class MaskRCNNFPNResNet(FasterRCNNFPNResNet):
    ...
    Please refer to :class:`~testcases.elichika_tests.chainercv_model.fpn.FasterRCNNFPNResNet`.
