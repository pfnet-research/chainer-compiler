...
def compile_model(model, inputs) -> 'ONNXModel':
    ...
    oc.chainer_f_converter[F.sin] = fb.ConverterChainerMathMisc('Sin')
    oc.chainer_f_converter[F.sinh] = fb.ConverterChainerMathMisc('Sinh')
    oc.chainer_f_converter[F.sign] = fb.ConverterChainerMathMisc('Sign')
    oc.chainer_f_converter[F.cos] = fb.ConverterChainerMathMisc('Cos')
    oc.chainer_f_converter[F.cosh] = fb.ConverterChainerMathMisc('Cosh')
    oc.chainer_f_converter[F.tan] = fb.ConverterChainerMathMisc('Tan')
    oc.chainer_f_converter[F.tanh] = fb.ConverterChainerMathMisc('Tanh')
    oc.chainer_f_converter[F.arcsin] = fb.ConverterChainerMathMisc('Asin')
    oc.chainer_f_converter[F.arccos] = fb.ConverterChainerMathMisc('Acos')
    oc.chainer_f_converter[F.arctan] = fb.ConverterChainerMathMisc('Atan')
    oc.chainer_f_converter[F.exp] = fb.ConverterChainerMathMisc('Exp')
    oc.chainer_f_converter[F.log] = fb.ConverterChainerMathMisc('Log')
