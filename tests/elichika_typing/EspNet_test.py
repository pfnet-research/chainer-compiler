...
class TestEspNet(unittest.TestCase):
    def test_AttDot(self):
        ...
        self.assertEqual(str(id2type[1]), "class AttDot -> ndarray(float32, (None, 3)) list -> NoneType -> NoneType -> (Variable(float32, (None, None)), Variable(float32, (None, None)))")	# FunctionDef forward (line 1)
        ...
        self.assertEqual(str(id2type[21]), "ndarray(float32, (None, 3)) list -> int")	# Name len (line 11)
        self.assertEqual(str(id2type[23]), "ndarray(float32, (None, 3)) list")	# Name enc_hs (line 11)
        ...
        self.assertEqual(str(id2type[34]), "Variable(float32, (None, None, None))")	# Attribute self.enc_h (line 15)
        self.assertEqual(str(id2type[35]), "class AttDot")	# Name self (line 15)
        self.assertEqual(str(id2type[38]), "Variable(float32, (None, None, None))")	# Call F.pad_sequence(enc_hs) (line 15)
        self.assertEqual(str(id2type[39]), "ndarray(float32, (None, 3)) list -> Variable(float32, (None, None, None))")	# Attribute F.pad_sequence (line 15)
        self.assertEqual(str(id2type[43]), "ndarray(float32, (None, 3)) list")	# Name enc_hs (line 15)
        ...
        self.assertEqual(str(id2type[60]), "Variable(float32, (None, None, None))")	# Attribute self.enc_h (line 18)
        ...
        self.assertEqual(str(id2type[69]), "Variable(float32, (None, None, None))")	# Attribute self.pre_compute_enc_h (line 20)
        self.assertEqual(str(id2type[70]), "class AttDot")	# Name self (line 20)
        self.assertEqual(str(id2type[73]), "Variable(float32, (None, None, None))")	# Call F.tanh(linear_tensor(self.mlp_enc, self.enc_h)) (line 20)
        self.assertEqual(str(id2type[74]), "Variable(float32, (None, None, None)) -> Variable(float32, (None, None, None))")	# Attribute F.tanh (line 20)
        self.assertEqual(str(id2type[78]), "Variable(float32, (None, None, None))")	# Call linear_tensor(self.mlp_enc, self.enc_h) (line 21)
        self.assertEqual(str(id2type[79]), "class Linear -> Variable(float32, (None, None, None)) -> Variable(float32, (None, None, None))")	# Name linear_tensor (line 21)
        ...
        self.assertEqual(str(id2type[85]), "Variable(float32, (None, None, None))")	# Attribute self.enc_h (line 21)
        ...
        self.assertEqual(str(id2type[96]), "Variable(float32, (None, 4))")	# Name dec_z (line 24)
        self.assertEqual(str(id2type[98]), "Variable(float32, (None, 4))")	# Call chainer.Variable(self.xp.zeros((batch, self.dunits), dtype=np.float32)) (line 24)
        self.assertEqual(str(id2type[99]), "ndarray(float32, (None, 4)) -> Variable(float32, (None, 4))")	# Attribute chainer.Variable (line 24)
        self.assertEqual(str(id2type[103]), "ndarray(float32, (None, 4))")	# Call self.xp.zeros((batch, self.dunits), dtype=np.float32) (line 24)
        self.assertEqual(str(id2type[104]), "(int, int) -> ndarray(float32, (None, 4))")	# Attribute self.xp.zeros (line 24)
        ...
        self.assertEqual(str(id2type[124]), "a14 (from line 27)")	# Name dec_z (line 27)
        self.assertEqual(str(id2type[126]), "a14 (from line 27)")	# Call F.reshape(dec_z, (batch, self.dunits)) (line 27)
        self.assertEqual(str(id2type[127]), "a10 -> (int, int) -> a14 (from line 27)")	# Attribute F.reshape (line 27)
        self.assertEqual(str(id2type[131]), "a10")	# Name dec_z (line 27)
        ...
        self.assertEqual(str(id2type[142]), "Variable(float32, (None, None, None))")	# Name u (line 30)
        self.assertEqual(str(id2type[144]), "Variable(float32, (None, None, None))")	# Call F.broadcast_to(F.expand_dims(F.tanh(self.mlp_dec(dec_z)), 1), self.pre_compute_enc_h.shape) (line 30)
        self.assertEqual(str(id2type[145]), "Variable(float32, (None, 1, 5)) -> (int, int, int) -> Variable(float32, (None, None, None))")	# Attribute F.broadcast_to (line 30)
        self.assertEqual(str(id2type[149]), "Variable(float32, (None, 1, 5))")	# Call F.expand_dims(F.tanh(self.mlp_dec(dec_z)), 1) (line 30)
        self.assertEqual(str(id2type[150]), "Variable(float32, (None, 5)) -> int -> Variable(float32, (None, 1, 5))")	# Attribute F.expand_dims (line 30)
        self.assertEqual(str(id2type[154]), "Variable(float32, (None, 5))")	# Call F.tanh(self.mlp_dec(dec_z)) (line 30)
        self.assertEqual(str(id2type[155]), "Variable(float32, (None, 5)) -> Variable(float32, (None, 5))")	# Attribute F.tanh (line 30)
        self.assertEqual(str(id2type[159]), "Variable(float32, (None, 5))")	# Call self.mlp_dec(dec_z) (line 30)
        self.assertEqual(str(id2type[160]), "Variable(float32, (None, 4)) -> Variable(float32, (None, 5))")	# Attribute self.mlp_dec (line 30)
        self.assertEqual(str(id2type[161]), "class AttDot")	# Name self (line 30)
        self.assertEqual(str(id2type[164]), "Variable(float32, (None, 4))")	# Name dec_z (line 30)
        ...
        self.assertEqual(str(id2type[168]), "Variable(float32, (None, None, None))")	# Attribute self.pre_compute_enc_h (line 31)
        self.assertEqual(str(id2type[169]), "class AttDot")	# Name self (line 31)
        self.assertEqual(str(id2type[173]), "NoneType")	# Assign
        self.assertEqual(str(id2type[174]), "Variable(float32, (None, None))")	# Name e (line 32)
        self.assertEqual(str(id2type[176]), "Variable(float32, (None, None))")	# Call F.sum(self.pre_compute_enc_h * u, axis=2) (line 32)
        self.assertEqual(str(id2type[177]), "Variable(float32, (None, None, None)) -> Variable(float32, (None, None))")	# Attribute F.sum (line 32)
        self.assertEqual(str(id2type[181]), "Variable(float32, (None, None, None))")	# BinOp self.pre_compute_enc_h * u (line 32)
        self.assertEqual(str(id2type[182]), "Variable(float32, (None, None, None))")	# Attribute self.pre_compute_enc_h (line 32)
        self.assertEqual(str(id2type[183]), "class AttDot")	# Name self (line 32)
        self.assertEqual(str(id2type[186]), "Variable(float32, (None, None, None)) -> Variable(float32, (None, None, None)) -> Variable(float32, (None, None, None))")	# Mult
        self.assertEqual(str(id2type[187]), "Variable(float32, (None, None, None))")	# Name u (line 32)
        self.assertEqual(str(id2type[190]), "int")	# Constant 2 (line 32)
        self.assertEqual(str(id2type[191]), "NoneType")	# Assign
        self.assertEqual(str(id2type[192]), "Variable(float32, (None, None))")	# Name w (line 36)
        self.assertEqual(str(id2type[194]), "Variable(float32, (None, None))")	# Call F.softmax(scaling * e) (line 36)
        self.assertEqual(str(id2type[195]), "Variable(float32, (None, None)) -> Variable(float32, (None, None))")	# Attribute F.softmax (line 36)
        self.assertEqual(str(id2type[199]), "Variable(float32, (None, None))")	# BinOp scaling * e (line 36)
        self.assertEqual(str(id2type[200]), "float")	# Name scaling (line 36)
        self.assertEqual(str(id2type[202]), "float -> Variable(float32, (None, None)) -> Variable(float32, (None, None))")	# Mult
        self.assertEqual(str(id2type[203]), "Variable(float32, (None, None))")	# Name e (line 36)
        self.assertEqual(str(id2type[205]), "NoneType")	# Assign
        self.assertEqual(str(id2type[206]), "Variable(float32, (None, None))")	# Name c (line 39)
        self.assertEqual(str(id2type[208]), "Variable(float32, (None, None))")	# Call F.sum(self.enc_h * F.broadcast_to(F.expand_dims(w, 2), self.enc_h.shape), axis=1) (line 39)
        self.assertEqual(str(id2type[209]), "Variable(float32, (None, None, None)) -> Variable(float32, (None, None))")	# Attribute F.sum (line 39)
        self.assertEqual(str(id2type[213]), "Variable(float32, (None, None, None))")	# BinOp self.enc_h * F.broadcast_to(F.expand_dims(w, 2), self.enc_h.shape) (line 39)
        self.assertEqual(str(id2type[214]), "Variable(float32, (None, None, None))")	# Attribute self.enc_h (line 39)
        self.assertEqual(str(id2type[215]), "class AttDot")	# Name self (line 39)
        self.assertEqual(str(id2type[218]), "Variable(float32, (None, None, None)) -> Variable(float32, (None, None, None)) -> Variable(float32, (None, None, None))")	# Mult
        self.assertEqual(str(id2type[219]), "Variable(float32, (None, None, None))")	# Call F.broadcast_to(F.expand_dims(w, 2), self.enc_h.shape) (line 39)
        self.assertEqual(str(id2type[220]), "Variable(float32, (None, None, 1)) -> (int, int, int) -> Variable(float32, (None, None, None))")	# Attribute F.broadcast_to (line 39)
        self.assertEqual(str(id2type[224]), "Variable(float32, (None, None, 1))")	# Call F.expand_dims(w, 2) (line 39)
        self.assertEqual(str(id2type[225]), "Variable(float32, (None, None)) -> int -> Variable(float32, (None, None, 1))")	# Attribute F.expand_dims (line 39)
        self.assertEqual(str(id2type[229]), "Variable(float32, (None, None))")	# Name w (line 39)
        ...
        self.assertEqual(str(id2type[233]), "Variable(float32, (None, None, None))")	# Attribute self.enc_h (line 39)
        self.assertEqual(str(id2type[234]), "class AttDot")	# Name self (line 39)
        self.assertEqual(str(id2type[239]), "int")	# Constant 1 (line 39)
        self.assertEqual(str(id2type[240]), "(Variable(float32, (None, None)), Variable(float32, (None, None)))")	# Return
        self.assertEqual(str(id2type[241]), "(Variable(float32, (None, None)), Variable(float32, (None, None)))")	# Tuple (c, w) (line 41)
        self.assertEqual(str(id2type[242]), "Variable(float32, (None, None))")	# Name c (line 41)
        self.assertEqual(str(id2type[244]), "Variable(float32, (None, None))")	# Name w (line 41)
        self.assertEqual(str(id2type[247]), "class Linear -> Variable(float32, (None, None, None)) -> Variable(float32, (None, None, None))")	# FunctionDef linear_tensor (line 1)
        ...
        self.assertEqual(str(id2type[256]), "Variable(float32, (None, 5))")	# Name y (line 9)
        self.assertEqual(str(id2type[258]), "Variable(float32, (None, 5))")	# Call linear(F.reshape(x, (-1, x.shape[-1]))) (line 9)
        self.assertEqual(str(id2type[259]), "Variable(float32, (None, None)) -> Variable(float32, (None, 5))")	# Name linear (line 9)
        self.assertEqual(str(id2type[261]), "Variable(float32, (None, None))")	# Call F.reshape(x, (-1, x.shape[-1])) (line 9)
        self.assertEqual(str(id2type[262]), "Variable(float32, (None, None, None)) -> (int, int) -> Variable(float32, (None, None))")	# Attribute F.reshape (line 9)
        self.assertEqual(str(id2type[266]), "Variable(float32, (None, None, None))")	# Name x (line 9)
        ...
        self.assertEqual(str(id2type[274]), "Variable(float32, (None, None, None))")	# Name x (line 9)
        self.assertEqual(str(id2type[278]), "int")	# UnaryOp -1 (line 9)
        self.assertEqual(str(id2type[280]), "int")	# Constant 1 (line 9)
        self.assertEqual(str(id2type[283]), "Variable(float32, (None, None, None))")	# Return
        self.assertEqual(str(id2type[284]), "Variable(float32, (None, None, None))")	# Call F.reshape(y, x.shape[:-1:] + (-1)) (line 10)
        self.assertEqual(str(id2type[285]), "Variable(float32, (None, 5)) -> (int, int, int) -> Variable(float32, (None, None, None))")	# Attribute F.reshape (line 10)
        self.assertEqual(str(id2type[289]), "Variable(float32, (None, 5))")	# Name y (line 10)
        ...
        self.assertEqual(str(id2type[294]), "Variable(float32, (None, None, None))")	# Name x (line 10)
    ...
    def test_AttLoc(self):
        ...
        self.assertEqual(str(id2type[1]), "class AttLoc -> ndarray(float32, (None, 3)) list -> NoneType -> NoneType -> (Variable(float32, (None, None)), Variable(float32, (None, None)))")	# FunctionDef forward (line 1)
        self.assertEqual(str(id2type[11]), "NoneType")	# Expr
        ...
        self.assertEqual(str(id2type[21]), "ndarray(float32, (None, 3)) list -> int")	# Name len (line 12)
        self.assertEqual(str(id2type[23]), "ndarray(float32, (None, 3)) list")	# Name enc_hs (line 12)
        self.assertEqual(str(id2type[25]), "NoneType")	# If
        ...
        self.assertEqual(str(id2type[33]), "NoneType")	# Assign
        self.assertEqual(str(id2type[34]), "Variable(float32, (None, None, None))")	# Attribute self.enc_h (line 16)
        self.assertEqual(str(id2type[35]), "class AttLoc")	# Name self (line 16)
        self.assertEqual(str(id2type[38]), "Variable(float32, (None, None, None))")	# Call F.pad_sequence(enc_hs) (line 16)
        self.assertEqual(str(id2type[39]), "ndarray(float32, (None, 3)) list -> Variable(float32, (None, None, None))")	# Attribute F.pad_sequence (line 16)
        self.assertEqual(str(id2type[43]), "ndarray(float32, (None, 3)) list")	# Name enc_hs (line 16)
        self.assertEqual(str(id2type[45]), "NoneType")	# If
        self.assertEqual(str(id2type[46]), "bool")	# Compare  (line 17)
        ...
        self.assertEqual(str(id2type[77]), "Variable(float32, (None, None, 5))")	# Attribute self.pre_compute_enc_h (line 23)
        self.assertEqual(str(id2type[78]), "class AttLoc")	# Name self (line 23)
        self.assertEqual(str(id2type[81]), "Variable(float32, (None, None, 5))")	# Call linear_tensor_3d(self.mlp_enc, self.enc_h) (line 23)
        self.assertEqual(str(id2type[82]), "class Linear -> Variable(float32, (None, None, None)) -> Variable(float32, (None, None, 5))")	# Name linear_tensor_3d (line 23)
        ...
        self.assertEqual(str(id2type[88]), "Variable(float32, (None, None, None))")	# Attribute self.enc_h (line 23)
        ...
        self.assertEqual(str(id2type[99]), "Variable(float32, (None, 4))")	# Name dec_z_new (line 26)
        self.assertEqual(str(id2type[101]), "Variable(float32, (None, 4))")	# Call chainer.Variable(self.xp.zeros((batch, self.dunits), dtype=np.float32)) (line 26)
        self.assertEqual(str(id2type[102]), "ndarray(float32, (None, 4)) -> Variable(float32, (None, 4))")	# Attribute chainer.Variable (line 26)
        self.assertEqual(str(id2type[106]), "ndarray(float32, (None, 4))")	# Call self.xp.zeros((batch, self.dunits), dtype=np.float32) (line 26)
        self.assertEqual(str(id2type[107]), "(int, int) -> ndarray(float32, (None, 4))")	# Attribute self.xp.zeros (line 26)
        ...
        self.assertEqual(str(id2type[127]), "a12 (from line 29)")	# Name dec_z_new (line 29)
        self.assertEqual(str(id2type[129]), "a12 (from line 29)")	# Call F.reshape(dec_z, (batch, self.dunits)) (line 29)
        self.assertEqual(str(id2type[130]), "a8 -> (int, int) -> a12 (from line 29)")	# Attribute F.reshape (line 29)
        self.assertEqual(str(id2type[134]), "a8")	# Name dec_z (line 29)
        ...
        self.assertEqual(str(id2type[217]), "Variable(float32, (None, 7, 1, None))")	# Name att_conv (line 40)
        self.assertEqual(str(id2type[219]), "Variable(float32, (None, 7, 1, None))")	# Call self.loc_conv(F.reshape(att_prev, (batch, 1, 1, self.h_length))) (line 40)
        self.assertEqual(str(id2type[220]), "Variable(float32, (None, 1, 1, None)) -> Variable(float32, (None, 7, 1, None))")	# Attribute self.loc_conv (line 40)
        self.assertEqual(str(id2type[221]), "class AttLoc")	# Name self (line 40)
        self.assertEqual(str(id2type[224]), "Variable(float32, (None, 1, 1, None))")	# Call F.reshape(att_prev, (batch, 1, 1, self.h_length)) (line 41)
        self.assertEqual(str(id2type[225]), "Variable(float32, (None, None)) -> (int, int, int, int) -> Variable(float32, (None, 1, 1, None))")	# Attribute F.reshape (line 41)
        ...
        self.assertEqual(str(id2type[242]), "Variable(float32, (None, None, 7))")	# Name att_conv (line 43)
        self.assertEqual(str(id2type[244]), "Variable(float32, (None, None, 7))")	# Call F.swapaxes(F.squeeze(att_conv, axis=2), 1, 2) (line 43)
        self.assertEqual(str(id2type[245]), "Variable(float32, (None, 7, None)) -> int -> int -> Variable(float32, (None, None, 7))")	# Attribute F.swapaxes (line 43)
        self.assertEqual(str(id2type[249]), "Variable(float32, (None, 7, None))")	# Call F.squeeze(att_conv, axis=2) (line 43)
        self.assertEqual(str(id2type[250]), "Variable(float32, (None, 7, 1, None)) -> Variable(float32, (None, 7, None))")	# Attribute F.squeeze (line 43)
        self.assertEqual(str(id2type[254]), "Variable(float32, (None, 7, 1, None))")	# Name att_conv (line 43)
        ...
        self.assertEqual(str(id2type[261]), "Variable(float32, (None, None, 5))")	# Name att_conv (line 45)
        self.assertEqual(str(id2type[263]), "Variable(float32, (None, None, 5))")	# Call linear_tensor_3d(self.mlp_att, att_conv) (line 45)
        self.assertEqual(str(id2type[264]), "class Linear -> Variable(float32, (None, None, 7)) -> Variable(float32, (None, None, 5))")	# Name linear_tensor_3d (line 45)
        ...
        self.assertEqual(str(id2type[270]), "Variable(float32, (None, None, 7))")	# Name att_conv (line 45)
        self.assertEqual(str(id2type[272]), "NoneType")	# Assign
        self.assertEqual(str(id2type[273]), "Variable(float32, (None, None, 5))")	# Name dec_z_tiled (line 48)
        self.assertEqual(str(id2type[275]), "Variable(float32, (None, None, 5))")	# Call F.broadcast_to(F.expand_dims(self.mlp_dec(dec_z_new), 1), self.pre_compute_enc_h.shape) (line 48)
        self.assertEqual(str(id2type[276]), "Variable(float32, (None, 1, 5)) -> (int, int, int) -> Variable(float32, (None, None, 5))")	# Attribute F.broadcast_to (line 48)
        self.assertEqual(str(id2type[280]), "Variable(float32, (None, 1, 5))")	# Call F.expand_dims(self.mlp_dec(dec_z_new), 1) (line 49)
        self.assertEqual(str(id2type[281]), "Variable(float32, (None, 5)) -> int -> Variable(float32, (None, 1, 5))")	# Attribute F.expand_dims (line 49)
        self.assertEqual(str(id2type[285]), "Variable(float32, (None, 5))")	# Call self.mlp_dec(dec_z_new) (line 49)
        self.assertEqual(str(id2type[286]), "Variable(float32, (None, 4)) -> Variable(float32, (None, 5))")	# Attribute self.mlp_dec (line 49)
        self.assertEqual(str(id2type[287]), "class AttLoc")	# Name self (line 49)
        self.assertEqual(str(id2type[290]), "Variable(float32, (None, 4))")	# Name dec_z_new (line 49)
        ...
        self.assertEqual(str(id2type[294]), "Variable(float32, (None, None, 5))")	# Attribute self.pre_compute_enc_h (line 49)
        self.assertEqual(str(id2type[295]), "class AttLoc")	# Name self (line 49)
        self.assertEqual(str(id2type[299]), "NoneType")	# Assign
        self.assertEqual(str(id2type[300]), "Variable(float32, (None, None))")	# Name e (line 54)
        self.assertEqual(str(id2type[302]), "Variable(float32, (None, None))")	# Call F.squeeze(linear_tensor_3d(self.gvec, F.tanh(att_conv + self.pre_compute_enc_h + dec_z_tiled)), axis=2) (line 54)
        self.assertEqual(str(id2type[303]), "Variable(float32, (None, None, 1)) -> Variable(float32, (None, None))")	# Attribute F.squeeze (line 54)
        self.assertEqual(str(id2type[307]), "Variable(float32, (None, None, 1))")	# Call linear_tensor_3d(self.gvec, F.tanh(att_conv + self.pre_compute_enc_h + dec_z_tiled)) (line 54)
        self.assertEqual(str(id2type[308]), "class Linear -> Variable(float32, (None, None, 5)) -> Variable(float32, (None, None, 1))")	# Name linear_tensor_3d (line 54)
        ...
        self.assertEqual(str(id2type[314]), "Variable(float32, (None, None, 5))")	# Call F.tanh(att_conv + self.pre_compute_enc_h + dec_z_tiled) (line 54)
        self.assertEqual(str(id2type[315]), "Variable(float32, (None, None, 5)) -> Variable(float32, (None, None, 5))")	# Attribute F.tanh (line 54)
        self.assertEqual(str(id2type[319]), "Variable(float32, (None, None, 5))")	# BinOp att_conv + self.pre_compute_enc_h + dec_z_tiled (line 55)
        self.assertEqual(str(id2type[320]), "Variable(float32, (None, None, 5))")	# BinOp att_conv + self.pre_compute_enc_h (line 55)
        self.assertEqual(str(id2type[321]), "Variable(float32, (None, None, 5))")	# Name att_conv (line 55)
        self.assertEqual(str(id2type[323]), "Variable(float32, (None, None, 5)) -> Variable(float32, (None, None, 5)) -> Variable(float32, (None, None, 5))")	# Add
        self.assertEqual(str(id2type[324]), "Variable(float32, (None, None, 5))")	# Attribute self.pre_compute_enc_h (line 55)
        self.assertEqual(str(id2type[325]), "class AttLoc")	# Name self (line 55)
        self.assertEqual(str(id2type[328]), "Variable(float32, (None, None, 5)) -> Variable(float32, (None, None, 5)) -> Variable(float32, (None, None, 5))")	# Add
        self.assertEqual(str(id2type[329]), "Variable(float32, (None, None, 5))")	# Name dec_z_tiled (line 55)
        self.assertEqual(str(id2type[332]), "int")	# Constant 2 (line 55)
        self.assertEqual(str(id2type[333]), "NoneType")	# Assign
        self.assertEqual(str(id2type[334]), "Variable(float32, (None, None))")	# Name w (line 59)
        self.assertEqual(str(id2type[336]), "Variable(float32, (None, None))")	# Call F.softmax(scaling * e) (line 59)
        self.assertEqual(str(id2type[337]), "Variable(float32, (None, None)) -> Variable(float32, (None, None))")	# Attribute F.softmax (line 59)
        self.assertEqual(str(id2type[341]), "Variable(float32, (None, None))")	# BinOp scaling * e (line 59)
        self.assertEqual(str(id2type[342]), "float")	# Name scaling (line 59)
        self.assertEqual(str(id2type[344]), "float -> Variable(float32, (None, None)) -> Variable(float32, (None, None))")	# Mult
        self.assertEqual(str(id2type[345]), "Variable(float32, (None, None))")	# Name e (line 59)
        self.assertEqual(str(id2type[347]), "NoneType")	# Assign
        self.assertEqual(str(id2type[348]), "Variable(float32, (None, None))")	# Name c (line 63)
        self.assertEqual(str(id2type[350]), "Variable(float32, (None, None))")	# Call F.sum(self.enc_h * F.broadcast_to(F.expand_dims(w, 2), self.enc_h.shape), axis=1) (line 63)
        self.assertEqual(str(id2type[351]), "Variable(float32, (None, None, None)) -> Variable(float32, (None, None))")	# Attribute F.sum (line 63)
        self.assertEqual(str(id2type[355]), "Variable(float32, (None, None, None))")	# BinOp self.enc_h * F.broadcast_to(F.expand_dims(w, 2), self.enc_h.shape) (line 63)
        self.assertEqual(str(id2type[356]), "Variable(float32, (None, None, None))")	# Attribute self.enc_h (line 63)
        self.assertEqual(str(id2type[357]), "class AttLoc")	# Name self (line 63)
        self.assertEqual(str(id2type[360]), "Variable(float32, (None, None, None)) -> Variable(float32, (None, None, None)) -> Variable(float32, (None, None, None))")	# Mult
        self.assertEqual(str(id2type[361]), "Variable(float32, (None, None, None))")	# Call F.broadcast_to(F.expand_dims(w, 2), self.enc_h.shape) (line 63)
        self.assertEqual(str(id2type[362]), "Variable(float32, (None, None, 1)) -> (int, int, int) -> Variable(float32, (None, None, None))")	# Attribute F.broadcast_to (line 63)
        self.assertEqual(str(id2type[366]), "Variable(float32, (None, None, 1))")	# Call F.expand_dims(w, 2) (line 63)
        self.assertEqual(str(id2type[367]), "Variable(float32, (None, None)) -> int -> Variable(float32, (None, None, 1))")	# Attribute F.expand_dims (line 63)
        self.assertEqual(str(id2type[371]), "Variable(float32, (None, None))")	# Name w (line 63)
        ...
        self.assertEqual(str(id2type[375]), "Variable(float32, (None, None, None))")	# Attribute self.enc_h (line 63)
        self.assertEqual(str(id2type[376]), "class AttLoc")	# Name self (line 63)
        self.assertEqual(str(id2type[381]), "int")	# Constant 1 (line 63)
        self.assertEqual(str(id2type[382]), "(Variable(float32, (None, None)), Variable(float32, (None, None)))")	# Return
        self.assertEqual(str(id2type[383]), "(Variable(float32, (None, None)), Variable(float32, (None, None)))")	# Tuple (c, w) (line 65)
        self.assertEqual(str(id2type[384]), "Variable(float32, (None, None))")	# Name c (line 65)
        self.assertEqual(str(id2type[386]), "Variable(float32, (None, None))")	# Name w (line 65)
        self.assertEqual(str(id2type[389]), "class Linear -> Variable(float32, (None, None, None)) -> Variable(float32, (None, None, 5))")	# FunctionDef linear_tensor_3d (line 1)
        self.assertEqual(str(id2type[395]), "NoneType")	# Expr
        self.assertEqual(str(id2type[396]), "string")	# Constant "..." (line 8)
        self.assertEqual(str(id2type[397]), "Variable(float32, (None, None, 5))")	# Return
        self.assertEqual(str(id2type[398]), "Variable(float32, (None, None, 5))")	# Call linear(x, n_batch_axes=2) (line 9)
        self.assertEqual(str(id2type[399]), "Variable(float32, (None, None, None)) -> Variable(float32, (None, None, 5))")	# Name linear (line 9)
        self.assertEqual(str(id2type[401]), "Variable(float32, (None, None, None))")	# Name x (line 9)
        self.assertEqual(str(id2type[404]), "int")	# Constant 2 (line 9)
        self.assertEqual(str(id2type[405]), "class Linear -> Variable(float32, (None, None, 7)) -> Variable(float32, (None, None, 5))")	# FunctionDef linear_tensor_3d (line 1)
        self.assertEqual(str(id2type[411]), "NoneType")	# Expr
        self.assertEqual(str(id2type[412]), "string")	# Constant "..." (line 8)
        self.assertEqual(str(id2type[413]), "Variable(float32, (None, None, 5))")	# Return
        self.assertEqual(str(id2type[414]), "Variable(float32, (None, None, 5))")	# Call linear(x, n_batch_axes=2) (line 9)
        self.assertEqual(str(id2type[415]), "Variable(float32, (None, None, 7)) -> Variable(float32, (None, None, 5))")	# Name linear (line 9)
        self.assertEqual(str(id2type[417]), "Variable(float32, (None, None, 7))")	# Name x (line 9)
        self.assertEqual(str(id2type[420]), "int")	# Constant 2 (line 9)
        self.assertEqual(str(id2type[421]), "class Linear -> Variable(float32, (None, None, 5)) -> Variable(float32, (None, None, 1))")	# FunctionDef linear_tensor_3d (line 1)
        self.assertEqual(str(id2type[427]), "NoneType")	# Expr
        self.assertEqual(str(id2type[428]), "string")	# Constant "..." (line 8)
        self.assertEqual(str(id2type[429]), "Variable(float32, (None, None, 1))")	# Return
        self.assertEqual(str(id2type[430]), "Variable(float32, (None, None, 1))")	# Call linear(x, n_batch_axes=2) (line 9)
        self.assertEqual(str(id2type[431]), "Variable(float32, (None, None, 5)) -> Variable(float32, (None, None, 1))")	# Name linear (line 9)
        self.assertEqual(str(id2type[433]), "Variable(float32, (None, None, 5))")	# Name x (line 9)
    ...
    def test_VGG2L(self):
        ...
        self.assertEqual(str(id2type[1]), "class VGG2L -> ndarray(float32, (None, 5)) list -> ndarray(int64, (3,)) -> (Variable(float32, (None, None)) list, ndarray(int64, (3,)))")	# FunctionDef forward (line 1)
        ...
        self.assertEqual(str(id2type[33]), "NoneType")	# Assign
        self.assertEqual(str(id2type[34]), "Variable(float32, (None, None, None))")	# Name xs (line 11)
        self.assertEqual(str(id2type[36]), "Variable(float32, (None, None, None))")	# Call F.pad_sequence(xs) (line 11)
        self.assertEqual(str(id2type[37]), "ndarray(float32, (None, 5)) list -> Variable(float32, (None, None, None))")	# Attribute F.pad_sequence (line 11)
        self.assertEqual(str(id2type[41]), "ndarray(float32, (None, 5)) list")	# Name xs (line 11)
        self.assertEqual(str(id2type[43]), "NoneType")	# Assign
        self.assertEqual(str(id2type[44]), "Variable(float32, (None, 1, None, None))")	# Name xs (line 14)
        self.assertEqual(str(id2type[46]), "Variable(float32, (None, 1, None, None))")	# Call F.swapaxes(F.reshape(xs, (xs.shape[0], xs.shape[1], self.in_channel, xs.shape[2] // self.in_channel)), 1, 2) (line 14)
        self.assertEqual(str(id2type[47]), "Variable(float32, (None, None, 1, None)) -> int -> int -> Variable(float32, (None, 1, None, None))")	# Attribute F.swapaxes (line 14)
        self.assertEqual(str(id2type[51]), "Variable(float32, (None, None, 1, None))")	# Call F.reshape(xs, (xs.shape[0], xs.shape[1], self.in_channel, xs.shape[2] // self.in_channel)) (line 14)
        self.assertEqual(str(id2type[52]), "Variable(float32, (None, None, None)) -> (int, int, int, int) -> Variable(float32, (None, None, 1, None))")	# Attribute F.reshape (line 14)
        self.assertEqual(str(id2type[56]), "Variable(float32, (None, None, None))")	# Name xs (line 15)
        ...
        self.assertEqual(str(id2type[61]), "Variable(float32, (None, None, None))")	# Name xs (line 15)
        ...
        self.assertEqual(str(id2type[69]), "Variable(float32, (None, None, None))")	# Name xs (line 15)
        ...
        self.assertEqual(str(id2type[82]), "Variable(float32, (None, None, None))")	# Name xs (line 15)
        ...
        self.assertEqual(str(id2type[96]), "NoneType")	# Assign
        self.assertEqual(str(id2type[97]), "Variable(float32, (None, 64, None, None))")	# Name xs (line 17)
        self.assertEqual(str(id2type[99]), "Variable(float32, (None, 64, None, None))")	# Call F.relu(self.conv1_1(xs)) (line 17)
        self.assertEqual(str(id2type[100]), "Variable(float32, (None, 64, None, None)) -> Variable(float32, (None, 64, None, None))")	# Attribute F.relu (line 17)
        self.assertEqual(str(id2type[104]), "Variable(float32, (None, 64, None, None))")	# Call self.conv1_1(xs) (line 17)
        self.assertEqual(str(id2type[105]), "Variable(float32, (None, 1, None, None)) -> Variable(float32, (None, 64, None, None))")	# Attribute self.conv1_1 (line 17)
        self.assertEqual(str(id2type[106]), "class VGG2L")	# Name self (line 17)
        self.assertEqual(str(id2type[109]), "Variable(float32, (None, 1, None, None))")	# Name xs (line 17)
        self.assertEqual(str(id2type[111]), "NoneType")	# Assign
        self.assertEqual(str(id2type[112]), "Variable(float32, (None, 64, None, None))")	# Name xs (line 18)
        self.assertEqual(str(id2type[114]), "Variable(float32, (None, 64, None, None))")	# Call F.relu(self.conv1_2(xs)) (line 18)
        self.assertEqual(str(id2type[115]), "Variable(float32, (None, 64, None, None)) -> Variable(float32, (None, 64, None, None))")	# Attribute F.relu (line 18)
        self.assertEqual(str(id2type[119]), "Variable(float32, (None, 64, None, None))")	# Call self.conv1_2(xs) (line 18)
        self.assertEqual(str(id2type[120]), "Variable(float32, (None, 64, None, None)) -> Variable(float32, (None, 64, None, None))")	# Attribute self.conv1_2 (line 18)
        self.assertEqual(str(id2type[121]), "class VGG2L")	# Name self (line 18)
        self.assertEqual(str(id2type[124]), "Variable(float32, (None, 64, None, None))")	# Name xs (line 18)
        self.assertEqual(str(id2type[126]), "NoneType")	# Assign
        self.assertEqual(str(id2type[127]), "Variable(float32, (None, 64, None, None))")	# Name xs (line 19)
        self.assertEqual(str(id2type[129]), "Variable(float32, (None, 64, None, None))")	# Call F.max_pooling_2d(xs, 2, stride=2) (line 19)
        self.assertEqual(str(id2type[130]), "Variable(float32, (None, 64, None, None)) -> int -> Variable(float32, (None, 64, None, None))")	# Attribute F.max_pooling_2d (line 19)
        self.assertEqual(str(id2type[134]), "Variable(float32, (None, 64, None, None))")	# Name xs (line 19)
        ...
        self.assertEqual(str(id2type[140]), "Variable(float32, (None, 128, None, None))")	# Name xs (line 21)
        self.assertEqual(str(id2type[142]), "Variable(float32, (None, 128, None, None))")	# Call F.relu(self.conv2_1(xs)) (line 21)
        self.assertEqual(str(id2type[143]), "Variable(float32, (None, 128, None, None)) -> Variable(float32, (None, 128, None, None))")	# Attribute F.relu (line 21)
        self.assertEqual(str(id2type[147]), "Variable(float32, (None, 128, None, None))")	# Call self.conv2_1(xs) (line 21)
        self.assertEqual(str(id2type[148]), "Variable(float32, (None, 64, None, None)) -> Variable(float32, (None, 128, None, None))")	# Attribute self.conv2_1 (line 21)
        self.assertEqual(str(id2type[149]), "class VGG2L")	# Name self (line 21)
        self.assertEqual(str(id2type[152]), "Variable(float32, (None, 64, None, None))")	# Name xs (line 21)
        self.assertEqual(str(id2type[154]), "NoneType")	# Assign
        self.assertEqual(str(id2type[155]), "Variable(float32, (None, 128, None, None))")	# Name xs (line 22)
        self.assertEqual(str(id2type[157]), "Variable(float32, (None, 128, None, None))")	# Call F.relu(self.conv2_2(xs)) (line 22)
        self.assertEqual(str(id2type[158]), "Variable(float32, (None, 128, None, None)) -> Variable(float32, (None, 128, None, None))")	# Attribute F.relu (line 22)
        self.assertEqual(str(id2type[162]), "Variable(float32, (None, 128, None, None))")	# Call self.conv2_2(xs) (line 22)
        self.assertEqual(str(id2type[163]), "Variable(float32, (None, 128, None, None)) -> Variable(float32, (None, 128, None, None))")	# Attribute self.conv2_2 (line 22)
        self.assertEqual(str(id2type[164]), "class VGG2L")	# Name self (line 22)
        self.assertEqual(str(id2type[167]), "Variable(float32, (None, 128, None, None))")	# Name xs (line 22)
        self.assertEqual(str(id2type[169]), "NoneType")	# Assign
        self.assertEqual(str(id2type[170]), "Variable(float32, (None, 128, None, None))")	# Name xs (line 23)
        self.assertEqual(str(id2type[172]), "Variable(float32, (None, 128, None, None))")	# Call F.max_pooling_2d(xs, 2, stride=2) (line 23)
        self.assertEqual(str(id2type[173]), "Variable(float32, (None, 128, None, None)) -> int -> Variable(float32, (None, 128, None, None))")	# Attribute F.max_pooling_2d (line 23)
        self.assertEqual(str(id2type[177]), "Variable(float32, (None, 128, None, None))")	# Name xs (line 23)
        ...
        self.assertEqual(str(id2type[205]), "Variable(float32, (None, None, 128, None))")	# Name xs (line 36)
        self.assertEqual(str(id2type[207]), "Variable(float32, (None, None, 128, None))")	# Call F.swapaxes(xs, 1, 2) (line 36)
        self.assertEqual(str(id2type[208]), "Variable(float32, (None, 128, None, None)) -> int -> int -> Variable(float32, (None, None, 128, None))")	# Attribute F.swapaxes (line 36)
        self.assertEqual(str(id2type[212]), "Variable(float32, (None, 128, None, None))")	# Name xs (line 36)
        self.assertEqual(str(id2type[214]), "int")	# Constant 1 (line 36)
        self.assertEqual(str(id2type[215]), "int")	# Constant 2 (line 36)
        self.assertEqual(str(id2type[216]), "NoneType")	# Assign
        self.assertEqual(str(id2type[217]), "Variable(float32, (None, None, None))")	# Name xs (line 37)
        self.assertEqual(str(id2type[219]), "Variable(float32, (None, None, None))")	# Call F.reshape(xs, (xs.shape[0], xs.shape[1], xs.shape[2] * xs.shape[3])) (line 37)
        self.assertEqual(str(id2type[220]), "Variable(float32, (None, None, 128, None)) -> (int, int, int) -> Variable(float32, (None, None, None))")	# Attribute F.reshape (line 37)
        self.assertEqual(str(id2type[224]), "Variable(float32, (None, None, 128, None))")	# Name xs (line 38)
        ...
        self.assertEqual(str(id2type[229]), "Variable(float32, (None, None, 128, None))")	# Name xs (line 38)
        ...
        self.assertEqual(str(id2type[237]), "Variable(float32, (None, None, 128, None))")	# Name xs (line 38)
        ...
        self.assertEqual(str(id2type[246]), "Variable(float32, (None, None, 128, None))")	# Name xs (line 38)
        ...
        self.assertEqual(str(id2type[255]), "Variable(float32, (None, None, 128, None))")	# Name xs (line 38)
        self.assertEqual(str(id2type[259]), "int")	# Constant 3 (line 38)
        self.assertEqual(str(id2type[262]), "NoneType")	# Assign
        self.assertEqual(str(id2type[263]), "Variable(float32, (None, None)) list")	# Name xs (line 39)
        self.assertEqual(str(id2type[265]), "Variable(float32, (None, None)) list")	# ListComp  (line 39)
        self.assertEqual(str(id2type[266]), "Variable(float32, (None, None))")	# Subscript xs[i, :ilens[i]:, ::] (line 39)
        self.assertEqual(str(id2type[267]), "Variable(float32, (None, None, None))")	# Name xs (line 39)
        ...
        self.assertEqual(str(id2type[294]), "(Variable(float32, (None, None)) list, ndarray(int64, (3,)))")	# Return
        self.assertEqual(str(id2type[295]), "(Variable(float32, (None, None)) list, ndarray(int64, (3,)))")	# Tuple (xs, ilens) (line 41)
        self.assertEqual(str(id2type[296]), "Variable(float32, (None, None)) list")	# Name xs (line 41)
    ...
    def test_BLSTM(self):
        ...
        self.assertEqual(str(id2type[1]), "class BLSTM -> ndarray(float32, (None, 5)) list -> ndarray(int64, (3,)) -> ((Variable(float32, (None, 7)), Variable(float32, (None, 7)), Variable(float32, (None, 7))), ndarray(int64, (3,)))")	# FunctionDef forward (line 1)
        self.assertEqual(str(id2type[9]), "NoneType")	# Expr
        self.assertEqual(str(id2type[10]), "string")	# Constant "..." (line 7)
        self.assertEqual(str(id2type[11]), "NoneType")	# Expr
        self.assertEqual(str(id2type[12]), "NoneType")	# Call logging.info(self.__class__.__name__ + ' input lengths: ' + str(ilens)) (line 8)
        ...
        self.assertEqual(str(id2type[43]), "NoneType")	# Assign
        self.assertEqual(str(id2type[44]), "(Variable(float32, (4, None, 3)), Variable(float32, (4, None, 3)), Variable(float32, (None, 6)) list)")	# Tuple (hy, cy, ys) (line 11)
        self.assertEqual(str(id2type[45]), "Variable(float32, (4, None, 3))")	# Name hy (line 11)
        self.assertEqual(str(id2type[47]), "Variable(float32, (4, None, 3))")	# Name cy (line 11)
        self.assertEqual(str(id2type[49]), "Variable(float32, (None, 6)) list")	# Name ys (line 11)
        self.assertEqual(str(id2type[52]), "(Variable(float32, (4, None, 3)), Variable(float32, (4, None, 3)), Variable(float32, (None, 6)) list)")	# Call self.nblstm(None, None, xs) (line 11)
        self.assertEqual(str(id2type[53]), "NoneType -> NoneType -> ndarray(float32, (None, 5)) list -> (Variable(float32, (4, None, 3)), Variable(float32, (4, None, 3)), Variable(float32, (None, 6)) list)")	# Attribute self.nblstm (line 11)
        ...
        self.assertEqual(str(id2type[59]), "ndarray(float32, (None, 5)) list")	# Name xs (line 11)
        self.assertEqual(str(id2type[61]), "NoneType")	# Assign
        self.assertEqual(str(id2type[62]), "Variable(float32, (None, 7))")	# Name ys (line 12)
        self.assertEqual(str(id2type[64]), "Variable(float32, (None, 7))")	# Call self.l_last(F.vstack(ys)) (line 12)
        self.assertEqual(str(id2type[65]), "Variable(float32, (None, 6)) -> Variable(float32, (None, 7))")	# Attribute self.l_last (line 12)
        self.assertEqual(str(id2type[66]), "class BLSTM")	# Name self (line 12)
        self.assertEqual(str(id2type[69]), "Variable(float32, (None, 6))")	# Call F.vstack(ys) (line 12)
        self.assertEqual(str(id2type[70]), "Variable(float32, (None, 6)) list -> Variable(float32, (None, 6))")	# Attribute F.vstack (line 12)
        self.assertEqual(str(id2type[74]), "Variable(float32, (None, 6)) list")	# Name ys (line 12)
        self.assertEqual(str(id2type[76]), "NoneType")	# Assign
        ...
        self.assertEqual(str(id2type[80]), "Variable(float32, (None, 7)) -> ndarray(int64, (2,)) -> int -> (Variable(float32, (None, 7)), Variable(float32, (None, 7)), Variable(float32, (None, 7)))")	# Attribute F.split_axis (line 13)
        self.assertEqual(str(id2type[84]), "Variable(float32, (None, 7))")	# Name ys (line 13)
