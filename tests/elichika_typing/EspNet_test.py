...
class TestEspNet(unittest.TestCase):
    def test_AttDot(self):
        ...
        self.assertEqual(str(id2type[52]), "optional(Variable(float32, (3, 4, 3)))")	# Attribute self.enc_h (line 15)
        ...
        self.assertEqual(str(id2type[70]), "Variable(float32, (3, 4, 5))")	# Call linear_tensor(self.mlp_enc, self.enc_h) (line 18)
        self.assertEqual(str(id2type[71]), "class Linear -> optional(Variable(float32, (3, 4, 3))) -> Variable(float32, (3, 4, 5))")	# Name linear_tensor (line 18)
        ...
        self.assertEqual(str(id2type[77]), "optional(Variable(float32, (3, 4, 3)))")	# Attribute self.enc_h (line 18)
        ...
        self.assertEqual(str(id2type[91]), "ndarray(float32, (3, 4)) -> Variable(float32, (3, 4))")	# Attribute chainer.Variable (line 21)
        self.assertEqual(str(id2type[95]), "ndarray(float32, (3, 4))")	# Call self.xp.zeros((batch, self.dunits), dtype=np.float32) (line 21)
        self.assertEqual(str(id2type[96]), "(int, int) -> ndarray(float32, (3, 4))")	# Attribute self.xp.zeros (line 21)
        ...
        self.assertEqual(str(id2type[134]), "Variable(float32, (3, 4, 5))")	# Name u (line 27)
        self.assertEqual(str(id2type[136]), "Variable(float32, (3, 4, 5))")	# Call F.broadcast_to(F.expand_dims(F.tanh(self.mlp_dec(dec_z)), 1), self.pre_compute_enc_h.shape) (line 27)
        self.assertEqual(str(id2type[137]), "Variable(float32, (3, 1, 5)) -> (int, int, int) -> Variable(float32, (3, 4, 5))")	# Attribute F.broadcast_to (line 27)
        self.assertEqual(str(id2type[141]), "Variable(float32, (3, 1, 5))")	# Call F.expand_dims(F.tanh(self.mlp_dec(dec_z)), 1) (line 27)
        self.assertEqual(str(id2type[142]), "Variable(float32, (3, 5)) -> int -> Variable(float32, (3, 1, 5))")	# Attribute F.expand_dims (line 27)
        self.assertEqual(str(id2type[146]), "Variable(float32, (3, 5))")	# Call F.tanh(self.mlp_dec(dec_z)) (line 27)
        self.assertEqual(str(id2type[147]), "Variable(float32, (3, 5)) -> Variable(float32, (3, 5))")	# Attribute F.tanh (line 27)
        self.assertEqual(str(id2type[151]), "Variable(float32, (3, 5))")	# Call self.mlp_dec(dec_z) (line 27)
        self.assertEqual(str(id2type[152]), "Variable(float32, (3, 4)) -> Variable(float32, (3, 5))")	# Attribute self.mlp_dec (line 27)
        self.assertEqual(str(id2type[153]), "class AttDot")	# Name self (line 27)
        self.assertEqual(str(id2type[156]), "Variable(float32, (3, 4))")	# Name dec_z (line 27)
        ...
        self.assertEqual(str(id2type[160]), "Variable(float32, (3, 4, 5))")	# Attribute self.pre_compute_enc_h (line 28)
        self.assertEqual(str(id2type[161]), "class AttDot")	# Name self (line 28)
        self.assertEqual(str(id2type[165]), "NoneType")	# Assign
        self.assertEqual(str(id2type[166]), "Variable(float32, (3, 4))")	# Name e (line 29)
        self.assertEqual(str(id2type[168]), "Variable(float32, (3, 4))")	# Call F.sum(self.pre_compute_enc_h * u, axis=2) (line 29)
        self.assertEqual(str(id2type[169]), "Variable(float32, (3, 4, 5)) -> Variable(float32, (3, 4))")	# Attribute F.sum (line 29)
        self.assertEqual(str(id2type[173]), "Variable(float32, (3, 4, 5))")	# BinOp self.pre_compute_enc_h * u (line 29)
        self.assertEqual(str(id2type[174]), "Variable(float32, (3, 4, 5))")	# Attribute self.pre_compute_enc_h (line 29)
        self.assertEqual(str(id2type[175]), "class AttDot")	# Name self (line 29)
        self.assertEqual(str(id2type[178]), "Variable(float32, (3, 4, 5)) -> Variable(float32, (3, 4, 5)) -> Variable(float32, (3, 4, 5))")	# Mult
        self.assertEqual(str(id2type[179]), "Variable(float32, (3, 4, 5))")	# Name u (line 29)
        self.assertEqual(str(id2type[182]), "int")	# Constant 2 (line 29)
        self.assertEqual(str(id2type[183]), "NoneType")	# Assign
        self.assertEqual(str(id2type[184]), "Variable(float32, (3, 4))")	# Name w (line 33)
        self.assertEqual(str(id2type[186]), "Variable(float32, (3, 4))")	# Call F.softmax(scaling * e) (line 33)
        self.assertEqual(str(id2type[187]), "Variable(float32, (3, 4)) -> Variable(float32, (3, 4))")	# Attribute F.softmax (line 33)
        self.assertEqual(str(id2type[191]), "Variable(float32, (3, 4))")	# BinOp scaling * e (line 33)
        self.assertEqual(str(id2type[192]), "float")	# Name scaling (line 33)
        self.assertEqual(str(id2type[194]), "float -> Variable(float32, (3, 4)) -> Variable(float32, (3, 4))")	# Mult
        self.assertEqual(str(id2type[195]), "Variable(float32, (3, 4))")	# Name e (line 33)
        self.assertEqual(str(id2type[197]), "NoneType")	# Assign
        self.assertEqual(str(id2type[198]), "Variable(float32, (3, 3))")	# Name c (line 36)
        self.assertEqual(str(id2type[200]), "Variable(float32, (3, 3))")	# Call F.sum(self.enc_h * F.broadcast_to(F.expand_dims(w, 2), self.enc_h.shape), axis=1) (line 36)
        self.assertEqual(str(id2type[201]), "Variable(float32, (3, 4, 3)) -> Variable(float32, (3, 3))")	# Attribute F.sum (line 36)
        self.assertEqual(str(id2type[205]), "Variable(float32, (3, 4, 3))")	# BinOp self.enc_h * F.broadcast_to(F.expand_dims(w, 2), self.enc_h.shape) (line 36)
        self.assertEqual(str(id2type[206]), "optional(Variable(float32, (3, 4, 3)))")	# Attribute self.enc_h (line 36)
        self.assertEqual(str(id2type[207]), "class AttDot")	# Name self (line 36)
        self.assertEqual(str(id2type[210]), "optional(Variable(float32, (3, 4, 3))) -> Variable(float32, (3, 4, 3)) -> Variable(float32, (3, 4, 3))")	# Mult
        self.assertEqual(str(id2type[211]), "Variable(float32, (3, 4, 3))")	# Call F.broadcast_to(F.expand_dims(w, 2), self.enc_h.shape) (line 36)
        self.assertEqual(str(id2type[212]), "Variable(float32, (3, 4, 1)) -> (int, int, int) -> Variable(float32, (3, 4, 3))")	# Attribute F.broadcast_to (line 36)
        self.assertEqual(str(id2type[216]), "Variable(float32, (3, 4, 1))")	# Call F.expand_dims(w, 2) (line 36)
        self.assertEqual(str(id2type[217]), "Variable(float32, (3, 4)) -> int -> Variable(float32, (3, 4, 1))")	# Attribute F.expand_dims (line 36)
        self.assertEqual(str(id2type[221]), "Variable(float32, (3, 4))")	# Name w (line 36)
        ...
        self.assertEqual(str(id2type[225]), "optional(Variable(float32, (3, 4, 3)))")	# Attribute self.enc_h (line 36)
        self.assertEqual(str(id2type[226]), "class AttDot")	# Name self (line 36)
        self.assertEqual(str(id2type[231]), "int")	# Constant 1 (line 36)
        self.assertEqual(str(id2type[232]), "(Variable(float32, (3, 3)), Variable(float32, (3, 4)))")	# Return
        self.assertEqual(str(id2type[233]), "(Variable(float32, (3, 3)), Variable(float32, (3, 4)))")	# Tuple (c, w) (line 38)
        self.assertEqual(str(id2type[234]), "Variable(float32, (3, 3))")	# Name c (line 38)
        self.assertEqual(str(id2type[236]), "Variable(float32, (3, 4))")	# Name w (line 38)
        self.assertEqual(str(id2type[239]), "class Linear -> optional(Variable(float32, (3, 4, 3))) -> Variable(float32, (3, 4, 5))")	# FunctionDef linear_tensor (line 1)
        ...
        self.assertEqual(str(id2type[248]), "Variable(float32, (12, 5))")	# Name y (line 9)
        self.assertEqual(str(id2type[250]), "Variable(float32, (12, 5))")	# Call linear(F.reshape(x, (-1, x.shape[-1]))) (line 9)
        self.assertEqual(str(id2type[251]), "Variable(float32, (12, 3)) -> Variable(float32, (12, 5))")	# Name linear (line 9)
        self.assertEqual(str(id2type[253]), "Variable(float32, (12, 3))")	# Call F.reshape(x, (-1, x.shape[-1])) (line 9)
        self.assertEqual(str(id2type[254]), "optional(Variable(float32, (3, 4, 3))) -> (int, int) -> Variable(float32, (12, 3))")	# Attribute F.reshape (line 9)
        self.assertEqual(str(id2type[258]), "optional(Variable(float32, (3, 4, 3)))")	# Name x (line 9)
        ...
        self.assertEqual(str(id2type[266]), "optional(Variable(float32, (3, 4, 3)))")	# Name x (line 9)
        self.assertEqual(str(id2type[270]), "int")	# UnaryOp -1 (line 9)
        self.assertEqual(str(id2type[272]), "int")	# Constant 1 (line 9)
        self.assertEqual(str(id2type[275]), "Variable(float32, (3, 4, 5))")	# Return
        self.assertEqual(str(id2type[276]), "Variable(float32, (3, 4, 5))")	# Call F.reshape(y, x.shape[:-1:] + (-1)) (line 10)
        self.assertEqual(str(id2type[277]), "Variable(float32, (12, 5)) -> (int, int, int) -> Variable(float32, (3, 4, 5))")	# Attribute F.reshape (line 10)
        self.assertEqual(str(id2type[281]), "Variable(float32, (12, 5))")	# Name y (line 10)
        ...
        self.assertEqual(str(id2type[286]), "optional(Variable(float32, (3, 4, 3)))")	# Name x (line 10)
    ...
    def test_AttLoc(self):
        ...
        self.assertEqual(str(id2type[52]), "optional(Variable(float32, (3, 4, 3)))")	# Attribute self.enc_h (line 16)
        ...
        self.assertEqual(str(id2type[86]), "ndarray(float32, (3, 4)) -> Variable(float32, (3, 4))")	# Attribute chainer.Variable (line 21)
        self.assertEqual(str(id2type[90]), "ndarray(float32, (3, 4))")	# Call self.xp.zeros((batch, self.dunits), dtype=np.float32) (line 21)
        self.assertEqual(str(id2type[91]), "(int, int) -> ndarray(float32, (3, 4))")	# Attribute self.xp.zeros (line 21)
        ...
        self.assertEqual(str(id2type[138]), "ndarray(float32, (4,))")	# Call self.xp.full(hh.shape[0], 1.0 / hh.shape[0], dtype=np.float32) (line 28)
        self.assertEqual(str(id2type[139]), "int -> float -> ndarray(float32, (4,))")	# Attribute self.xp.full (line 28)
        ...
        self.assertEqual(str(id2type[147]), "ndarray(float32, (4, 3))")	# Name hh (line 29)
        ...
        self.assertEqual(str(id2type[158]), "ndarray(float32, (4, 3))")	# Name hh (line 29)
        ...
        self.assertEqual(str(id2type[170]), "ndarray(float32, (4, 3))")	# Name hh (line 29)
        self.assertEqual(str(id2type[172]), "ndarray(float32, (4, 3)) list")	# Name enc_hs (line 29)
        self.assertEqual(str(id2type[174]), "NoneType")	# Assign
        self.assertEqual(str(id2type[175]), "Variable(float32, (4,)) list")	# Name att_prev (line 30)
        self.assertEqual(str(id2type[177]), "Variable(float32, (4,)) list")	# ListComp  (line 30)
        self.assertEqual(str(id2type[178]), "Variable(float32, (4,))")	# Call chainer.Variable(att) (line 30)
        self.assertEqual(str(id2type[179]), "ndarray(float32, (4,)) -> Variable(float32, (4,))")	# Attribute chainer.Variable (line 30)
        self.assertEqual(str(id2type[183]), "ndarray(float32, (4,))")	# Name att (line 30)
        self.assertEqual(str(id2type[186]), "ndarray(float32, (4,))")	# Name att (line 30)
        self.assertEqual(str(id2type[188]), "ndarray(float32, (4,)) list")	# Name att_prev (line 30)
        self.assertEqual(str(id2type[190]), "NoneType")	# Assign
        self.assertEqual(str(id2type[191]), "Variable(float32, (None, None))")	# Name att_prev (line 31)
        self.assertEqual(str(id2type[193]), "Variable(float32, (None, None))")	# Call F.pad_sequence(att_prev) (line 31)
        self.assertEqual(str(id2type[194]), "Variable(float32, (4,)) list -> Variable(float32, (None, None))")	# Attribute F.pad_sequence (line 31)
        self.assertEqual(str(id2type[198]), "Variable(float32, (4,)) list")	# Name att_prev (line 31)
        self.assertEqual(str(id2type[200]), "NoneType")	# Assign
        self.assertEqual(str(id2type[201]), "Variable(float32, (3, 7, 1, 4))")	# Name att_conv (line 35)
        self.assertEqual(str(id2type[203]), "Variable(float32, (3, 7, 1, 4))")	# Call self.loc_conv(F.reshape(att_prev, (batch, 1, 1, self.h_length))) (line 35)
        self.assertEqual(str(id2type[204]), "Variable(float32, (3, 1, 1, 4)) -> Variable(float32, (3, 7, 1, 4))")	# Attribute self.loc_conv (line 35)
        self.assertEqual(str(id2type[205]), "class AttLoc")	# Name self (line 35)
        self.assertEqual(str(id2type[208]), "Variable(float32, (3, 1, 1, 4))")	# Call F.reshape(att_prev, (batch, 1, 1, self.h_length)) (line 36)
        self.assertEqual(str(id2type[209]), "Variable(float32, (None, None)) -> (int, int, int, optional(int)) -> Variable(float32, (3, 1, 1, 4))")	# Attribute F.reshape (line 36)
        self.assertEqual(str(id2type[213]), "Variable(float32, (None, None))")	# Name att_prev (line 36)
        ...
        self.assertEqual(str(id2type[226]), "Variable(float32, (3, 4, 7))")	# Name att_conv (line 38)
        self.assertEqual(str(id2type[228]), "Variable(float32, (3, 4, 7))")	# Call F.swapaxes(F.squeeze(att_conv, axis=2), 1, 2) (line 38)
        self.assertEqual(str(id2type[229]), "Variable(float32, (3, 7, 4)) -> int -> int -> Variable(float32, (3, 4, 7))")	# Attribute F.swapaxes (line 38)
        self.assertEqual(str(id2type[233]), "Variable(float32, (3, 7, 4))")	# Call F.squeeze(att_conv, axis=2) (line 38)
        self.assertEqual(str(id2type[234]), "Variable(float32, (3, 7, 1, 4)) -> Variable(float32, (3, 7, 4))")	# Attribute F.squeeze (line 38)
        self.assertEqual(str(id2type[238]), "Variable(float32, (3, 7, 1, 4))")	# Name att_conv (line 38)
        ...
        self.assertEqual(str(id2type[270]), "Variable(float32, (3, 4)) -> Variable(float32, (3, 5))")	# Attribute self.mlp_dec (line 44)
    ...
    def test_StatelessLSTM(self):
        ...
        self.assertEqual(str(id2type[1]), "class StatelessLSTM -> ndarray(float32, (3, 4)) -> ndarray(float32, (3, 4)) -> ndarray(float32, (3, 7)) -> (Variable(float32, (3, 4)), Variable(float32, (3, 4)))")	# FunctionDef forward (line 1)
        self.assertEqual(str(id2type[11]), "NoneType")	# Expr
        ...
        self.assertEqual(str(id2type[17]), "ndarray(float32, (3, 7)) -> Variable(float32, (3, 16))")	# Attribute self.upward (line 22)
        ...
        self.assertEqual(str(id2type[34]), "ndarray(float32, (3, 4)) -> Variable(float32, (3, 16))")	# Attribute self.lateral (line 24)
        ...
        self.assertEqual(str(id2type[64]), "ndarray(float32, (3, 7))")	# Name x (line 32)
