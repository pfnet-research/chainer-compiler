...
class TestEspNet(unittest.TestCase):
    ...
    def test_AttLoc(self):
        ...
        self.assertEqual(str(id2type[151]), "ndarray(float32, (4,)) list")	# Name att_prev (line 33)
        self.assertEqual(str(id2type[153]), "ndarray(float32, (4,)) list")	# ListComp  (line 33)
        self.assertEqual(str(id2type[154]), "ndarray(float32, (4,))")	# Call self.xp.full(hh.shape[0], 1.0 / hh.shape[0], dtype=np.float32) (line 33)
        self.assertEqual(str(id2type[155]), "int -> float -> ndarray(float32, (4,))")	# Attribute self.xp.full (line 33)
        ...
        self.assertEqual(str(id2type[163]), "ndarray(float32, (4, 3))")	# Name hh (line 34)
        ...
        self.assertEqual(str(id2type[174]), "ndarray(float32, (4, 3))")	# Name hh (line 34)
        ...
        self.assertEqual(str(id2type[186]), "ndarray(float32, (4, 3))")	# Name hh (line 34)
        self.assertEqual(str(id2type[188]), "ndarray(float32, (4, 3)) list")	# Name enc_hs (line 34)
        self.assertEqual(str(id2type[190]), "NoneType")	# Assign
        self.assertEqual(str(id2type[191]), "Variable(float32, (4,)) list")	# Name att_prev (line 35)
        self.assertEqual(str(id2type[193]), "Variable(float32, (4,)) list")	# ListComp  (line 35)
        self.assertEqual(str(id2type[194]), "Variable(float32, (4,))")	# Call chainer.Variable(att) (line 35)
        self.assertEqual(str(id2type[195]), "ndarray(float32, (4,)) -> Variable(float32, (4,))")	# Attribute chainer.Variable (line 35)
        self.assertEqual(str(id2type[199]), "ndarray(float32, (4,))")	# Name att (line 35)
        self.assertEqual(str(id2type[202]), "ndarray(float32, (4,))")	# Name att (line 35)
        self.assertEqual(str(id2type[204]), "ndarray(float32, (4,)) list")	# Name att_prev (line 35)
        ...
        self.assertEqual(str(id2type[210]), "Variable(float32, (4,)) list -> Variable(float32, (None, None))")	# Attribute F.pad_sequence (line 36)
        self.assertEqual(str(id2type[214]), "Variable(float32, (4,)) list")	# Name att_prev (line 36)
