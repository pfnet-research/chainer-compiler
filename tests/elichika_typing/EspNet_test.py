...
class TestEspNet(unittest.TestCase):
    def test_AttDot(self):
        ...
        self.assertEqual(str(id2type[124]), "a14")	# Name dec_z (line 27)
        self.assertEqual(str(id2type[126]), "a12 (from line 27)")	# Call F.reshape(dec_z, (batch, self.dunits)) (line 27)
        self.assertEqual(str(id2type[127]), "NoneType -> (int, int) -> a12 (from line 27)")	# Attribute F.reshape (line 27)
    ...
    def test_AttLoc(self):
        ...
        self.assertEqual(str(id2type[127]), "a11")	# Name dec_z_new (line 29)
        self.assertEqual(str(id2type[129]), "a9 (from line 29)")	# Call F.reshape(dec_z, (batch, self.dunits)) (line 29)
        self.assertEqual(str(id2type[130]), "NoneType -> (int, int) -> a9 (from line 29)")	# Attribute F.reshape (line 29)
