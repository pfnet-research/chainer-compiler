...
class TestNumpy(unittest.TestCase):
    def test_numpy_array(self):
        ...
        self.assertEqual(str(id2type[9]), "[int] -> ndarray(int64, (1,))")	# Attribute np.array (line 2)
        ...
        self.assertEqual(str(id2type[20]), "int -> ndarray(float64, ())")	# Attribute np.array (line 3)
        ...
        self.assertEqual(str(id2type[34]), "[int] -> ndarray(float32, (1,))")	# Attribute np.array (line 4)
        ...
        self.assertEqual(str(id2type[47]), "string -> ndarray(float32, (0,))")	# Attribute np.zeros(0).astype (line 5)
        self.assertEqual(str(id2type[48]), "ndarray(float64, (0,))")	# Call np.zeros(0) (line 5)
        self.assertEqual(str(id2type[49]), "int -> ndarray(float64, (0,))")	# Attribute np.zeros (line 5)
        ...
        self.assertEqual(str(id2type[60]), "dtype(int32) -> ndarray(int32, (0,))")	# Attribute np.zeros(0).astype (line 6)
        self.assertEqual(str(id2type[61]), "ndarray(float64, (0,))")	# Call np.zeros(0) (line 6)
        self.assertEqual(str(id2type[62]), "int -> ndarray(float64, (0,))")	# Attribute np.zeros (line 6)
    ...
    def test_numpy_zeros(self):
        ...
        self.assertEqual(str(id2type[9]), "(int, int) -> ndarray(float64, (3, 3))")	# Attribute np.zeros (line 2)
        ...
        self.assertEqual(str(id2type[21]), "int -> ndarray(int64, (3,))")	# Attribute np.zeros (line 3)
    ...
    def test_expand_dims(self):
        ...
        self.assertEqual(str(id2type[7]), "ndarray(float64, (2, 3, 4)) -> int -> Variable(float64, (2, 1, 3, 4))")	# Attribute F.expand_dims (line 2)
        self.assertEqual(str(id2type[11]), "ndarray(float64, (2, 3, 4))")	# Call np.zeros((2, 3, 4)) (line 2)
        self.assertEqual(str(id2type[12]), "(int, int, int) -> ndarray(float64, (2, 3, 4))")	# Attribute np.zeros (line 2)
        ...
        self.assertEqual(str(id2type[24]), "ndarray(float64, (2, 3, 4)) -> int -> Variable(float64, (2, 3, 1, 4))")	# Attribute F.expand_dims (line 3)
        self.assertEqual(str(id2type[28]), "ndarray(float64, (2, 3, 4))")	# Call np.zeros((2, 3, 4)) (line 3)
        self.assertEqual(str(id2type[29]), "(int, int, int) -> ndarray(float64, (2, 3, 4))")	# Attribute np.zeros (line 3)
    ...
    def test_squeeze(self):
        ...
        self.assertEqual(str(id2type[7]), "ndarray(float64, (2, 1, 1, 3)) -> Variable(float64, (2, 3))")	# Attribute F.squeeze (line 2)
        self.assertEqual(str(id2type[11]), "ndarray(float64, (2, 1, 1, 3))")	# Call np.zeros((2, 1, 1, 3)) (line 2)
        self.assertEqual(str(id2type[12]), "(int, int, int, int) -> ndarray(float64, (2, 1, 1, 3))")	# Attribute np.zeros (line 2)
        ...
        self.assertEqual(str(id2type[24]), "ndarray(float64, (2, 1, 1, 3)) -> Variable(float64, (2, 1, 3))")	# Attribute F.squeeze (line 3)
        self.assertEqual(str(id2type[28]), "ndarray(float64, (2, 1, 1, 3))")	# Call np.zeros((2, 1, 1, 3)) (line 3)
        self.assertEqual(str(id2type[29]), "(int, int, int, int) -> ndarray(float64, (2, 1, 1, 3))")	# Attribute np.zeros (line 3)
        ...
        self.assertEqual(str(id2type[43]), "ndarray(float64, (2, 1, 1, 3)) -> Variable(float64, (2, 3))")	# Attribute F.squeeze (line 4)
        self.assertEqual(str(id2type[47]), "ndarray(float64, (2, 1, 1, 3))")	# Call np.zeros((2, 1, 1, 3)) (line 4)
        self.assertEqual(str(id2type[48]), "(int, int, int, int) -> ndarray(float64, (2, 1, 1, 3))")	# Attribute np.zeros (line 4)
    ...
    def test_sum(self):
        ...
        self.assertEqual(str(id2type[7]), "ndarray(float64, (1, 2, 3)) -> Variable(float64, (1, 2))")	# Attribute F.sum (line 3)
        self.assertEqual(str(id2type[11]), "ndarray(float64, (1, 2, 3))")	# Call np.zeros((1, 2, 3)) (line 3)
        self.assertEqual(str(id2type[12]), "(int, int, int) -> ndarray(float64, (1, 2, 3))")	# Attribute np.zeros (line 3)
        ...
        self.assertEqual(str(id2type[27]), "ndarray(float64, (1, 2, 3)) -> Variable(float64, (1, 1, 3))")	# Attribute F.sum (line 4)
        self.assertEqual(str(id2type[31]), "ndarray(float64, (1, 2, 3))")	# Call np.zeros((1, 2, 3)) (line 4)
        self.assertEqual(str(id2type[32]), "(int, int, int) -> ndarray(float64, (1, 2, 3))")	# Attribute np.zeros (line 4)
        ...
        self.assertEqual(str(id2type[47]), "ndarray(float64, (1, 2, 3)) -> Variable(float64, (1, 1, 1))")	# Attribute F.sum (line 5)
        self.assertEqual(str(id2type[51]), "ndarray(float64, (1, 2, 3))")	# Call np.zeros((1, 2, 3)) (line 5)
        self.assertEqual(str(id2type[52]), "(int, int, int) -> ndarray(float64, (1, 2, 3))")	# Attribute np.zeros (line 5)
    ...
    def test_separate(self):
        ...
        self.assertEqual(str(id2type[7]), "ndarray(float64, (3, 4, 5)) -> (Variable(float64, (4, 5)), Variable(float64, (4, 5)), Variable(float64, (4, 5)))")	# Attribute F.separate (line 2)
        self.assertEqual(str(id2type[11]), "ndarray(float64, (3, 4, 5))")	# Call np.zeros((3, 4, 5)) (line 2)
        self.assertEqual(str(id2type[12]), "(int, int, int) -> ndarray(float64, (3, 4, 5))")	# Attribute np.zeros (line 2)
    ...
    def test_split_axis(self):
        ...
        self.assertEqual(str(id2type[7]), "ndarray(float64, (3, 4, 5)) -> int -> int -> (Variable(float64, (3, 2, 5)), Variable(float64, (3, 2, 5)))")	# Attribute F.split_axis (line 3)
        self.assertEqual(str(id2type[11]), "ndarray(float64, (3, 4, 5))")	# Call np.zeros((3, 4, 5)) (line 3)
        self.assertEqual(str(id2type[12]), "(int, int, int) -> ndarray(float64, (3, 4, 5))")	# Attribute np.zeros (line 3)
    ...
    def test_vstack(self):
        ...
        self.assertEqual(str(id2type[7]), "[ndarray(float64, (1, 3, 4)), ndarray(float64, (2, 3, 4))] -> Variable(float64, (3, 3, 4))")	# Attribute F.vstack (line 2)
        ...
        self.assertEqual(str(id2type[13]), "(int, int, int) -> ndarray(float64, (1, 3, 4))")	# Attribute np.zeros (line 2)
        ...
        self.assertEqual(str(id2type[23]), "(int, int, int) -> ndarray(float64, (2, 3, 4))")	# Attribute np.zeros (line 2)
