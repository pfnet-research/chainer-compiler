...
class TestMLP(unittest.TestCase):
    def test_MLP(self):
        ...
        self.assertEqual(str(id2type[1]), "MLP -> ndarray(dtype(float32), shape=(100, 3)) -> ndarray(dtype(int64), shape=(100,)) -> Variable(dtype(float32), shape=None)")	# FunctionDef forward (line 1)
        ...
        self.assertEqual(str(id2type[19]), "MLP")	# Name self (line 2)
        ...
        self.assertEqual(str(id2type[34]), "MLP")	# Name self (line 3)
        ...
        self.assertEqual(str(id2type[44]), "MLP")	# Name self (line 4)
