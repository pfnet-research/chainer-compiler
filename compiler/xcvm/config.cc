...
public:
    explicit XCVMCompilerConfig(bool diversed) {
        ...
        CHECK(op_set_.emplace(Node::kAcosh).second);
        CHECK(op_set_.emplace(Node::kAdd).second);
        CHECK(op_set_.emplace(Node::kAnd).second);
        CHECK(op_set_.emplace(Node::kArgMax).second);
        CHECK(op_set_.emplace(Node::kAsin).second);
        CHECK(op_set_.emplace(Node::kAsinh).second);
        CHECK(op_set_.emplace(Node::kAtan).second);
        CHECK(op_set_.emplace(Node::kAtanh).second);
        ...
        CHECK(op_set_.emplace(Node::kCos).second);
        CHECK(op_set_.emplace(Node::kCosh).second);
        ...
        CHECK(op_set_.emplace(Node::kTan).second);
