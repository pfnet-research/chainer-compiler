...
public:
    ...
    const int64_t ir_version() const { return ir_version_; }
    const std::vector<onnx::OperatorSetIdProto>& opset_import() const { return opset_import_; }
    ...
    const std::map<std::string, std::string>& metadata_props() const { return metadata_props_; }
