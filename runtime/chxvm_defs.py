...
CHX_OPS = [
    ...
    ('GetItemGrad',
     ...
     ['output']),
    ('SetItem', [Array('data'), ArrayList('slices'), Array('value'),
                 Ints('slice_specs')],
     ['output']),
...
CHX_SEQ_OPS = [
    ...
    ('SequenceLookupGrad', [Array('gy'), Scalar('size'), Scalar('index')],
     [Sequence('gx')]),
    ('SequenceUpdate', [Sequence('seq'), Scalar('index'), Array('value')],
     [Sequence('output')]),
    ('SequenceGetSlice',
    ...
    ('SequenceConcat', [Sequence('seq'), Int('axis')],
     ['output', 'ctx']),
    ('SequenceSplitAxis',
     [Array('seq'), OptionalArray('indices_or_sections'), Int('axis')],
     [Sequence('output')]),
    ...
    ('SequenceRange',
     ...
     [Sequence('output')]),
    ('SequenceSeparate', [Array('input'), Int('axis')],
     [Sequence('output')]),
