...
TEST_CASES = [
    ...
    # TODO(hamaji): Implement Resize-11.
    # TestCase(NODE_TEST, 'test_resize_downsample_scales_cubic'),
    # TestCase(NODE_TEST, 'test_resize_downsample_scales_cubic_A_n0p5_exclude_outside'),
    # TestCase(NODE_TEST, 'test_resize_downsample_scales_cubic_align_corners'),
    # TestCase(NODE_TEST, 'test_resize_downsample_scales_linear'),
    # TestCase(NODE_TEST, 'test_resize_downsample_scales_linear_align_corners'),
    # TestCase(NODE_TEST, 'test_resize_downsample_scales_nearest'),
    # TestCase(NODE_TEST, 'test_resize_downsample_sizes_cubic'),
    # TestCase(NODE_TEST, 'test_resize_downsample_sizes_linear_pytorch_half_pixel'),
    # TestCase(NODE_TEST, 'test_resize_downsample_sizes_nearest'),
    # TestCase(NODE_TEST, 'test_resize_downsample_sizes_nearest_tf_half_pixel_for_nn'),
    # TestCase(NODE_TEST, 'test_resize_tf_crop_and_resize'),
    # TestCase(NODE_TEST, 'test_resize_upsample_scales_cubic'),
    # TestCase(NODE_TEST, 'test_resize_upsample_scales_cubic_A_n0p5_exclude_outside'),
    # TestCase(NODE_TEST, 'test_resize_upsample_scales_cubic_align_corners'),
    # TestCase(NODE_TEST, 'test_resize_upsample_scales_cubic_asymmetric'),
    # TestCase(NODE_TEST, 'test_resize_upsample_scales_linear'),
    # TestCase(NODE_TEST, 'test_resize_upsample_scales_linear_align_corners'),
    # TestCase(NODE_TEST, 'test_resize_upsample_scales_nearest'),
    # TestCase(NODE_TEST, 'test_resize_upsample_sizes_cubic'),
    # TestCase(NODE_TEST, 'test_resize_upsample_sizes_nearest'),
    # TestCase(NODE_TEST, 'test_resize_upsample_sizes_nearest_ceil_half_pixel'),
    # TestCase(NODE_TEST, 'test_resize_upsample_sizes_nearest_floor_align_corners'),
    # TestCase(NODE_TEST, 'test_resize_upsample_sizes_nearest_round_prefer_ceil_asymmetric'),
